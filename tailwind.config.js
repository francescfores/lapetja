  ...
  //   // }),
    createThemes({
      light: {
        ...
        'btn_disabled_bg_back_color': '#636262',
      ...
      dark: {
        ...
        'bgSeco': '#141f38',//0A131F
        'bgTern': '#083344',//1e314b #474954
        // 'secondary': '#CBF7ED',
        // 'ternary': '#1D3557',
        // 'quaternary': '#1D3557',
        ...
        'btn_primary_border_style': '#70FF0A',
        'btn_primary_bg_front_color': '#88FF33',
        'btn_primary_bg_shadow_color': '#4B4B4B84',
        'btn_primary_bg_back_color': '#4CB800',
        'btn_primary_font_color': '#fff',
